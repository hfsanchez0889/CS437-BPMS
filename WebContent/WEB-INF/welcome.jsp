...
<div class="wrapper col2">
  <div id="container" class="clear"> 
    ...
    <div style="text-align:center"> 
     ...
     <h1 style="color:black; ">Your break is about to begin!!! Please hit the start link to be taken to your break!!</h1> 
    </div>
    <div style="text-align:center"> 
   <font size="100px"><a href="display"  class="btn btn-lg btn-danger"><h1>START</h1></a></font>
